...
@Slf4j
@Service
public class FTLCodeGeneratorService {
	...
	public Set<String> processFTLFiles(com.tsys.enterprise.model.Configuration config) {
		...
		for (File file : folder.listFiles()) {
			...
			String jsonFilePath = filePath.substring(0, filePath.lastIndexOf(".")) + JSON_EXTENSION;
	...
	private void processFTLFile(HTMLmodel model, Configuration freeMarkerConfiguration, String generatedFileType,
		...
		Template template = freeMarkerConfiguration.getTemplate(fileName + FTL_EXTENSION);
